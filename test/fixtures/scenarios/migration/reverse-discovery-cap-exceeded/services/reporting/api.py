"""reporting HTTP surface. Blueprint per service, /v1 prefix, health endpoint."""
...
bp = Blueprint("reporting", __name__, url_prefix="/v1/reporting")
...
def show(item_id):
    ...
    if item is None:
        raise NotFound("reporting item not found")
    return item
