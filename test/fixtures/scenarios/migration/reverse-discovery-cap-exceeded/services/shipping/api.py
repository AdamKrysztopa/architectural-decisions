"""shipping HTTP surface. Blueprint per service, /v1 prefix, health endpoint."""
...
bp = Blueprint("shipping", __name__, url_prefix="/v1/shipping")
...
def show(item_id):
    ...
    if item is None:
        raise NotFound("shipping item not found")
    return item
