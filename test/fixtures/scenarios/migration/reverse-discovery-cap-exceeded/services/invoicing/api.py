"""invoicing HTTP surface. Blueprint per service, /v1 prefix, health endpoint."""
...
bp = Blueprint("invoicing", __name__, url_prefix="/v1/invoicing")
...
def show(item_id):
    ...
    if item is None:
        raise NotFound("invoicing item not found")
    return item
