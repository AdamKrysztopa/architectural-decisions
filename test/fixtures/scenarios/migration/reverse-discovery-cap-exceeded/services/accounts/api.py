"""accounts HTTP surface. Blueprint per service, /v1 prefix, health endpoint."""
...
bp = Blueprint("accounts", __name__, url_prefix="/v1/accounts")
...
def show(item_id):
    ...
    if item is None:
        raise NotFound("accounts item not found")
    return item
