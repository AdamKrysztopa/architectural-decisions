"""ratelimit HTTP surface. Blueprint per service, /v1 prefix, health endpoint."""
...
bp = Blueprint("ratelimit", __name__, url_prefix="/v1/ratelimit")
...
def show(item_id):
    ...
    if item is None:
        raise NotFound("ratelimit item not found")
    return item
