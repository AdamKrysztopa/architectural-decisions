"""pricing HTTP surface. Blueprint per service, /v1 prefix, health endpoint."""
...
bp = Blueprint("pricing", __name__, url_prefix="/v1/pricing")
...
def show(item_id):
    ...
    if item is None:
        raise NotFound("pricing item not found")
    return item
